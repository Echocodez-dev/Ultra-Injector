all you need to do to install and run is 1. disable av if neeeded 2. extract the folder 3. open the debug folder and run the program with the needle icon
